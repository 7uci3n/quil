...
2. _Wait for quality-agent spec review_
3. **TESTS (RED)** — Write test files covering ALL acceptance criteria. Tests MUST fail.
4. _Wait for quality-agent RED verification_
...
8. _Wait for quality-agent GREEN verification_
9. **VALIDATE** — Run linter, type checker, full test suite with coverage.
10. _Wait for code review and security scan_
