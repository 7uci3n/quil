...
import { requireChannel } from "../config/validaters.js";
...
export async function execute(ix: ChatInputCommandInteraction) {
  if (!await requireChannel(ix, [REWARDS_CHANNEL_ID, MAGIC_ITEMS_CHANNEL_ID], { errorKey: 'sell.notInResourceChannel' })) return;
